...
import { ACTIVITY_ID, ZKPASS_BYBIT_OWNER_SCHEMA_ID } from "./constants";
...
const handleNewMessage: ActivityOnMessage = async (
  ...
  try {
    ...
    toast.success(
      "Congrats, you have completed the activity 'Prove ownership and claim a Bybit credential'"
    );
  } catch (error: unknown) {
  ...
  try {
    ...
    return {
      ...
      message: defineMessage({
        id: "activities.claimBybitOwnerzkPass.executePendingMessage",
        defaultMessage:
    ...
    return {
      status: "todo",
      message: defineMessage({
        id: "activities.claimBybitOwnerzkPass.gettingExecutionErrorMessage",
...
export const activity: Activity = {
  ...
  title: defineMessage({
    id: "activities.claimBybitOwnerzkPass.title",
    defaultMessage: "Prove ownership and claim a Bybit credential",
    description:
      "Title of the activity 'Prove ownership and claim a Bybit credential'",
  }),
  description: defineMessage({
    id: "activities.claimBybitOwnerzkPass.shortDescription",
    defaultMessage: `Prove ownership and claim a credential of your Bybit account. The credentials will be securely stored on the Verida Network, and can be shared and verified.`,
    description:
      "Short description of the activity 'Prove ownership and claim a Bybit credential'",
  }),
  longDescription: defineMessage({
    id: "activities.claimBybitOwnerzkPass.longDescription",
    defaultMessage: `Prove ownership and claim a credential of your Bybit account. The credentials will be securely stored on the Verida Network, and can be shared and verified.{newline}{newline}Step 1. Click on the 'Verify' button and follow the instructions to perform the verification process. Once done, the proof will be sent to your inbox.{newline}{newline}Step 2. Accept the proof credential received in your inbox to save the credential. {newline}{newline}Step 3. Reply to the message sent by Verida Missions to share your new credential.`,
    description:
      "Long description of the activity 'Prove ownership and claim a Bybit credential'",
  }),
  actionLabel: defineMessage({
    id: "activities.claimBybitOwnerzkPass.actionLabel",
    defaultMessage: "Verify",
    description:
      "Label of the button to start the activity Claim Bybit ownership",
  }),
  actionReExecuteLabel: defineMessage({
    id: "activities.claimBybitOwnerzkPass.actionReExecuteLabel",
    defaultMessage: "Verify again",
    description: "Label of the button to perform the activity again ",
  }),
  actionExecutingLabel: defineMessage({
    id: "activities.claimBybitOwnerzkPass.actionExecutingLabel",
  ...
  steps: [
    {
      order: 1,
      description: defineMessage({
        id: "activities.claimBybitOwnerzkPass.step1.description",
        defaultMessage:
        ...
        description:
          "Step 1 of the activity 'Prove ownership and claim a Bybit credential'",
      }),
    },
    {
      order: 2,
      description: defineMessage({
        id: "activities.claimBybitOwnerzkPass.step2.description",
        defaultMessage:
          "Accept the proof credential received in your inbox to save the credential.",
        description:
          "Step 2 of the activity 'Prove ownership and claim a Bybit credential'",
      }),
    },
    {
      order: 3,
      description: defineMessage({
        id: "activities.claimBybitOwnerzkPass.step3.description",
        defaultMessage:
          "Reply to the message sent by Verida Missions to share your new credential.",
        description:
          "Step 3 of the activity 'Prove ownership and claim a Bybit credential'",
      }),
    },
  ],
  resources: [
    {
      label: defineMessage({
        id: "activities.claimBybitOwnerzkPass.resources.ZkPassPageUrl.label",
