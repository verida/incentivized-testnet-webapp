...
export const activity: Activity = {
  ...
  shortDescription: defineMessage({
    ...
    defaultMessage: `Prove ownership and claim a Bybit credential using zkPass protocol. The credentials should be stored in your Verida Wallet.`,
    description:
  ...
  longDescription: defineMessage({
    ...
    defaultMessage: `Prove ownership and claim a credential of your Bybit account. The credentials will be stored in your Verida Wallet, and can be securely shared and verified.{newline}{newline}Step 1. Click on the 'Verify' button and follow the instructions to perform the verification process. Once done, the proof will be sent to your inbox.{newline}{newline}Step 2. Accept the proof credential received in your inbox to save the credential. {newline}{newline}Step 3. Reply to the message sent by Verida missions to share your new credential .{newline}{newline}`,
    description:
