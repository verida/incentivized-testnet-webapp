...
export const activity: Activity = {
  ...
  shortDescription: defineMessage({
    ...
    defaultMessage: `Prove ownership and claim a Bybit credential using zkPass protocol. The credentails should be stored in your verida wallet.`,
    description:
