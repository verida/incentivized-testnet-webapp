...
export const activity: Activity = {
  ...
  shortDescription: defineMessage({
    ...
    defaultMessage: `Prove ownership and claim a MEXC credential using zkPass protocol. The credentails should be stored in your verida wallet.`,
    description:
  ...
  longDescription: defineMessage({
    ...
    defaultMessage: `Prove ownership and claim a MEXC credential. The credentails will be stored in your Verida Wallet, and can be securely shared and verified.{newline}{newline}Step 1. Go to proof-connector app and complete verification process for MEXC account.{newline}{newline}Step 2. Open your Verida Wallet inbox and accept message from proof-connector. {newline}{newline}Step 3. Accept request from verida mission to share credentials.{newline}{newline}Step 4. Select and share credentials.
      `,
    description:
