...
const handleNewMessage: ActivityOnMessage = async (
  ...
  try {
    ...
    toast.success(
      "Congrats, you have completed the activity 'Claim a MEXC credential/Prove ownership'"
    );
  } catch (error: unknown) {
...
export const activity: Activity = {
  ...
  title: defineMessage({
    ...
    defaultMessage: "Claim a MEXC credential/Prove ownership",
    description:
      "Title of the activity 'Claim a MEXC credential/Prove ownership'",
  }),
  shortDescription: defineMessage({
    id: "activities.claimMEXCOwner.shortDescription",
    defaultMessage: `Claim a MEXC credential/Prove ownership using ZkPass protocol. The credentails should be stored in your verida wallet.`,
    description:
      "Short description of the activity 'Claim a MEXC credential/Prove ownership'",
  }),
  longDescription: defineMessage({
    id: "activities.claimMEXCOwner.longDescription",
    defaultMessage: `Claim a MEXC credential/Prove ownership. The credentails will be stored in your Verida Wallet, and can be securely shared and verified.{newline}{newline}Step1. Go to proof-dapp-connector app and complete verification process for MEXC account.{newline}{newline}Step2. Open your Verida Wallet inbox and accept message from dapp-connector. {newline}{newline}Step3. Accept request from verida mission to share credentials.{newline}{newline}Step4. Select and share credentials.
      `,
    description:
      "Long description of the activity 'Claim a MEXC credential/Prove ownership'",
  }),
