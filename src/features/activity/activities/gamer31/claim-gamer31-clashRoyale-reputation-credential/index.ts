...
const ACTIVITY_ID = "claim-gamer31-clashroyale-reputation-credential"; // Never change the id
...
const handleNewMessage: ActivityOnMessage = async (
  ...
  try {
    ...
    toast.success(
      "Congrats, you have completed the activity 'Claim a Gamer31 Clash Royale credential'"
    );
  } catch (error: unknown) {
...
const handleExecute: ActivityOnExecute = async (veridaWebUser) => {
  ...
  try {
    ...
    const message = "Please share a Gamer31 Clash Royale credential";
    ...
    const sentMessage = await sendDataRequest(veridaWebUser.current, {
      ...
      filter: {
        $or: GAMER31_CLASH_ROYALE_VC_SCHEMA_URLS.map((url) => ({
    ...
    return {
      ...
      message: defineMessage({
        id: "activities.claimGamer31ClashRoyale.executePendingMessage",
        defaultMessage:
          "A request has been sent to your Wallet inbox. Please check your inbox and share a Gamer31 Clash Royale credential.",
        description:
    ...
    return {
      status: "todo",
      message: defineMessage({
        id: "activities.claimGamer31ClashRoyale.gettingExecutionErrorMessage",
...
export const activity: Activity = {
  ...
  points: 50,
  title: defineMessage({
    id: "activities.claimGamer31ClashRoyale.title",
    defaultMessage: "Claim a Gamer31 Clash Royale credential",
    description:
      "Title of the activity 'Claim Gamer31 Clash Royale credential'",
  }),
  shortDescription: defineMessage({
    id: "activities.claimGamer31ClashRoyale.shortDescription",
    defaultMessage: `Temporary disabled, will come back soon.{newline}{newline}Celebrate your accomplishments in Clash Royale by claiming the Gamer31 Clash Royale proof of reputation credential. The credential will be stored in your Verida Wallet, and can be securely shared and verified.`,
    description:
  ...
  actionLabel: defineMessage({
    ...
    description:
      "Label of the button to start the activity claim Gamer31 Clash Royale credential",
  }),
  actionReExecuteLabel: defineMessage({
    id: "activities.claimGamer31ClashRoyale.actionReExecuteLabel",
    defaultMessage: "Re-send Request",
    description: "Label of the button to perform the activity again ",
  }),
  actionExecutingLabel: defineMessage({
    id: "activities.claimGamer31ClashRoyale.actionExecutingLabel",
    defaultMessage: "Sending Request",
    description:
      "Label of the button when the activity 'claim Gamer31 Clash Royale credential' is being executed",
  }),
  onInit: handleInit,
  ...
  resources: [
    {
      label: defineMessage({
        id: "activities.claimGamer31ClashRoyale.resources.gamer31ClaimPageUrl.label",
