  ...
  steps: [
    {
      order: 1,
      description: defineMessage({
        id: "activities.claimGamer31ClashRoyale.step1.description",
        defaultMessage:
          "Go to the Gamer 31 claim page (link in the resources) and click on the Clash Royale 'Claim' button to start the process.",
        description:
    ...
    },
    {
      order: 2,
      description: defineMessage({
        id: "activities.claimGamer31ClashRoyale.step2.description",
        defaultMessage:
    ...
    },
    {
      order: 3,
      description: defineMessage({
        id: "activities.claimGamer31ClashRoyale.step3.description",
        defaultMessage:
