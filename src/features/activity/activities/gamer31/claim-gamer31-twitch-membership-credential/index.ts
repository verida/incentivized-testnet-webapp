...
export const activity: Activity = {
  ...
  shortDescription: defineMessage({
    ...
    defaultMessage: `Temporary disabled, please check the Verida Discord for more information.{newline}{newline}Establish your Twitch account ownership by claiming the Gamer31 Twitch proof of membership credential. The credential will be stored in your Verida Wallet, and can be securely shared and verified.`,
    description:
      "Short description of the activity 'claim Gamer31 Twitch credential'",
  }),
  longDescription: defineMessage({
    id: "activities.claimGamer31Twitch.longDescription",
    defaultMessage: `Temporary disabled, please check the Verida Discord for more information.{newline}{newline}Establish your Twitch account ownership by claiming the Gamer31 Twitch proof of membership credential. The credential will be stored in your Verida Wallet, and can be securely shared and verified.{newline}{newline}Step 1. Go to the Gamer 31 claim page (link in the resources below) and click on the Twitch 'Claim' button to start the process.{newline}{newline}Step 2. Follow the instructions to connect with your Twitch account, then to claim the credential by scanning the two QR codes with your Verida Wallet.{newline}{newline}Step 3. Click the 'Send Request' button on Verida Missions and share the credential by replying to the message you received in your Wallet inbox.`,
    description:
