...
export const activity: Activity = {
  ...
  shortDescription: defineMessage({
    ...
    defaultMessage: `Temporary disabled, will come back soon.{newline}{newline}Highlight your achievements in Clash of Clans by claiming the Gamer31 Clash of Clans proof of reputation credential.  The credential will be stored in your Verida Wallet, and can be securely shared and verified.`,
    description:
