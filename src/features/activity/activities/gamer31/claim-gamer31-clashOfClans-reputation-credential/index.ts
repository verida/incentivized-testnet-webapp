...
export const activity: Activity = {
  ...
  shortDescription: defineMessage({
    ...
    defaultMessage: `Claim the Gamer31 Clash of Clans proof of reputation credential to showcase your activity! The credential will be stored in your Verida Wallet, and can be securely shared and verified.`,
    description:
