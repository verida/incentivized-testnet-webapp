...
export const activity: Activity = {
  ...
  shortDescription: defineMessage({
    ...
    defaultMessage: `Claim the Gamer31 Clash Royal proof of reputation credential to showcase your activity! The credential will be stored in your Verida Wallet, and can be securely shared and verified.`,
    description:
  ...
  longDescription: defineMessage({
    ...
    defaultMessage: `Claim the Gamer31 Clash Royal proof of reputation credential to showcase your activity! The credential will be stored in your Verida Wallet, and can be securely shared and verified.{newline}{newline}Step 1. Go to the Gamer 31 claim page (link in the resources below) and click on the Clash Royal 'Claim' button to start the process.{newline}{newline}Step 2. Follow the instructions to connect with your Supercell account, then to claim the credential by scanning the two QR codes with your Verida Wallet.{newline}{newline}Step 3. Click the 'Send Request' button on Verida Missions and share the credential by replying to the message you received in your Wallet inbox.`,
    description:
