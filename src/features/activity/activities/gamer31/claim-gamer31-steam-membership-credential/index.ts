...
const ACTIVITY_ID = "claim-gamer31-steam-membership-credential"; // Never change the id
...
const handleNewMessage: ActivityOnMessage = async (
  ...
  try {
    ...
    toast.success(
      "Congrats, you have completed the activity 'Claim a Gamer31 Steam credential'"
    );
  } catch (error: unknown) {
...
const handleExecute: ActivityOnExecute = async (veridaWebUser) => {
  ...
  try {
    ...
    const message = "Please share a Gamer31 Steam credential";
    ...
    const sentMessage = await sendDataRequest(veridaWebUser.current, {
      ...
      filter: {
        $or: GAMER31_STEAM_VC_SCHEMA_URLS.map((url) => ({
    ...
    return {
      ...
      message: defineMessage({
        id: "activities.claimGamer31Steam.executePendingMessage",
        defaultMessage:
          "A request has been sent to your Wallet inbox. Please check your inbox and share a Gamer31 Steam credential.",
        description:
    ...
    return {
      status: "todo",
      message: defineMessage({
        id: "activities.claimGamer31Steam.gettingExecutionErrorMessage",
...
export const activity: Activity = {
  ...
  actionLabel: defineMessage({
    ...
    description:
      "Label of the button to start the activity claim Gamer31 Steam credential",
  }),
  actionReExecuteLabel: defineMessage({
    id: "activities.claimGamer31Steam.actionReExecuteLabel",
    defaultMessage: "Re-send Request",
    description: "Label of the button to perform the activity again ",
  }),
  actionExecutingLabel: defineMessage({
    id: "activities.claimGamer31Steam.actionExecutingLabel",
    defaultMessage: "Sending Request",
    description:
      "Label of the button when the activity 'claim Gamer31 Steam credential' is being executed",
  }),
  onInit: handleInit,
  ...
  steps: [
    {
      id: "activities.claimGamer31Steam.step1",
      defaultMessage:
        "Go to the Gamer 31 claim page (link in the resources below) and click on the Steam 'Claim' button to start the process.",
      description: "Step 1 of the activity 'claim Gamer31 Steam credential'",
    },
    {
      id: "activities.claimGamer31Steam.step2",
      defaultMessage:
    ...
    {
      id: "activities.claimGamer31Steam.step3",
      defaultMessage:
  ...
  resources: [
    {
      label: defineMessage({
        id: "activities.claimGamer31Steam.resources.gamer31ClaimPageUrl.label",
