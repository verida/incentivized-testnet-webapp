...
export type LegacyMissionSectionProps = {
  mission: Mission;
} & React.ComponentPropsWithRef<"article">;

export const LegacyMissionSection: React.FunctionComponent<
